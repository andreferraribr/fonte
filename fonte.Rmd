...
Apliquei um filtro para criar a rubica "demais".
...
```{r, compacto Governo Federal 2018: pagamentos por esfera, resultado primário, fonte e elemento  (R$ bi),fig.width = 15,  fig.height= 9}
outflux_s<- outflux%>%
  # filtra pelo ano de 2018 e valore maiores que R$ 0
